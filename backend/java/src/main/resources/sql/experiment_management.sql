...
) ENGINE=InnoDB AUTO_INCREMENT=702 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2022 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=354 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2025-06-26 22:53:03','',NULL,'超级管理员'),(2,'教师','teacher',2,'2',1,1,'0','0','admin','2025-06-26 22:53:03','admin','2026-02-25 17:54:29','教师'),(3,'学生','student',3,'1',1,1,'0','0','admin','2025-12-03 22:19:53','admin','2026-02-25 17:54:37','学生');
...
INSERT INTO `sys_role_menu` VALUES (2,2009),(2,2010),(2,2011),(2,2012),(2,2015),(2,2016),(2,2017),(2,2018),(2,2019),(2,2020),(2,2021),(3,2009),(3,2010),(3,2011),(3,2016),(3,2017),(3,2018),(3,2019),(3,2020),(3,2021);
...
CREATE TABLE `task` (
  ...
  `report_flag` tinyint NOT NULL DEFAULT '2' COMMENT '是否要求执行人定时汇报：1需要，2不需要',
  `report_frequency` int DEFAULT NULL COMMENT '执行人定时汇报频率（单位：天）',
  `create_user_id` bigint NOT NULL COMMENT '创建用户id',
...
INSERT INTO `task` VALUES (86,0,'1.20-1.22差旅报销','该任务用于1.20-1.22的差旅报销','如有不明确事项请先与老师沟通',1,1,2,2,NULL,107,'梁齐哲','2026-01-22 21:17:55','2026-01-23 00:00:00',NULL,'2026-02-12 22:59:36'),(87,86,'票据整理与保管','','',1,2,4,2,NULL,107,'梁齐哲','2026-01-22 21:38:56',NULL,NULL,'2026-02-12 21:02:42'),(88,86,'报销单填写与提交','','',2,2,1,2,NULL,107,'梁齐哲','2026-01-22 21:39:21',NULL,NULL,'2026-02-12 21:02:31'),(89,86,'审批、打款与归款','','',3,2,3,2,NULL,107,'梁齐哲','2026-01-22 21:39:38',NULL,NULL,'2026-01-22 21:51:08'),(91,87,'查验','','',2,3,3,2,NULL,107,'梁齐哲','2026-01-22 21:40:15',NULL,NULL,'2026-02-12 23:00:02'),(92,88,'填写基本信息','','',1,3,3,2,NULL,107,'梁齐哲','2026-01-22 21:40:46',NULL,NULL,'2026-01-22 21:51:15'),(93,88,'录入费用与明细','','',2,3,3,2,NULL,107,'梁齐哲','2026-01-22 21:40:55',NULL,NULL,'2026-01-22 21:51:38'),(120,92,'1','','',1,4,2,2,NULL,107,'梁齐哲','2026-02-09 23:41:12',NULL,NULL,'2026-02-09 23:41:12'),(135,0,'测试权限','','',1,1,2,2,NULL,107,'梁齐哲','2026-02-12 23:41:03',NULL,NULL,'2026-02-22 17:26:24'),(136,135,'张三的任务','','',1,2,2,1,3,107,'梁齐哲','2026-02-12 23:41:15',NULL,NULL,'2026-02-25 20:00:41'),(137,135,'陈胜的任务','','',2,2,3,2,NULL,107,'梁齐哲','2026-02-12 23:41:32',NULL,NULL,'2026-02-22 17:13:54'),(138,135,'陈琳的任务','','',3,2,1,2,NULL,107,'梁齐哲','2026-02-12 23:41:53',NULL,NULL,'2026-02-12 23:41:53'),(140,136,'张三交给陈胜的任务','','',1,3,3,2,NULL,108,'张三','2026-02-12 23:51:36',NULL,NULL,'2026-02-22 17:44:49'),(141,140,'陈胜交给李四的任务','','',1,4,3,2,NULL,111,'陈胜','2026-02-12 23:56:41',NULL,NULL,'2026-02-22 17:44:52');
...
CREATE TABLE `task_user` (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=486 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='任务关联用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-02-25 20:02:11
