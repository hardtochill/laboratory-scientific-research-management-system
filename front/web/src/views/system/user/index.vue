  ...
  <div class="app-container">
      ...
      <el-col>
            ...
            <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
              <el-form-item label="用户学号" prop="userName">
                <el-input v-model="queryParams.userName" placeholder="请输入用户学号" clearable style="width: 240px" @keyup.enter="handleQuery" />
              </el-form-item>
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form :model="form" :rules="rules" ref="userRef" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="用户学号" prop="userName">
...
const data = reactive({
  ...
  rules: {
    userName: [{ required: true, message: "用户学号不能为空", trigger: "blur" }, { min: 2, max: 20, message: "用户学号长度必须介于 2 和 20 之间", trigger: "blur" }],
